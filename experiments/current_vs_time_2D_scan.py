...
class transistor_laser_scan(interactive_ui):
    ...
    def __init__(self, stage_X, stage_Y, datafile, transistor_transfer, current_vs_time ):
        super().__init__()
    ...
    def measure_grid_point(self):
        ...
        self.current_vs_time.start_measurement(datafile=self.datafile, path=self.active_point_group.name)
        ...
        self.active_point_group.attrs.create('timestamp', self.datafile.timestamp())
        self.update_progress()
        
    def save_scan_attrs(self):
        scan_label = self.datafile.get_unique_group_name(self.datafile, basename=self.description, max_N=100)
...
if __name__ == '__main__' :
    ...
    scan_ui = transistor_laser_scan(stage_X, stage_Y, datafile, transistor_transfer_ui, current_vs_time_ui)
