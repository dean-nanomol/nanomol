...
class transistor_output_transfer_LED(interactive_ui):
    """
    Class for measurement of transistor output and transfer curves with LED illumination.
    ...
    def __init__(self, datafile, smu, LED):
        super().__init__()
        self.datafile = datafile
        self.smu = smu
        self.LED = LED
        ui_file_path = os.path.join(os.path.dirname(__file__), 'transistor_output_transfer_LED.ui')
...
if __name__ == '__main__' :
    ...
    experiment = transistor_output_transfer_LED(datafile, smu, LED_ui)
    experiment.show()
    smu_ui.show()
    LED_ui.show()
